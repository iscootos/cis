...
{
	printf("%9d\n", 123);      //'      123'占据9个字符的空间，默认右对齐
	printf("%-9d\n", 123);     //'123      '占据9个字符的空间，- 为左对齐
	printf("%09d\n", 123);     //'000000123'占据9个字符的空间，默认右对齐，前面用0填充
	printf("%+9d\n", 123);     //'     +123'
	printf("%-+9d\n", 123);    //'+123     '
	printf("%--9d\n", 123);    //'123      '
	printf("%9.2f\n", 123.0);  //'   123.00'占据9个字符的空间，小数点后两位
	printf("%*d\n", 9, 123);   //'      123'*用第一个参数去代替就是9,所以就是%9d
